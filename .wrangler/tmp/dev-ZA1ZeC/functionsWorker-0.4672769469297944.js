...
// .wrangler/tmp/bundle-7dl2wD/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-vAk9xk/functionsWorker-0.4672769469297944.mjs
...
var clean = /* @__PURE__ */ __name2((v) => String(v == null ? "" : v).trim().slice(0, MAX_FIELD), "clean");
var isEmail = /* @__PURE__ */ __name2((v) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v), "isEmail");
...
// .wrangler/tmp/bundle-7dl2wD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7dl2wD/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4672769469297944.js.map
