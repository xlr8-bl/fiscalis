...
/* h030 was cut: he looked at it and it is not one of his. */
export const CHOSEN = [
...
export const NOTES = {
  h006: 'The white shirt, run off the LEFT EDGE and scaled up, unflipped so '
      + 'he faces right into the sheet, '
      + 'and standing on the STRIP RULE rather than on the panel\'s foot. The '
      + 'rule is the horizontal this sheet has, and standing him on it puts '
      + 'him across the panel instead of inside it.',
  h024: 'Was a question, a figure and nothing else, which is restraint at '
      ...
      + 'The caption is ONE SENTENCE and the renderer wraps it. It was set '
      + '`fit: shrink`, which fits one line by shrinking it, so it had to be '
      + 'handed a list of lines and then read as four unrelated claims '
      + 'instead of a sentence. Anywhere a block is prose, it is `wrap`.',
  h051: 'Photograph stood on the floor rule and moved to the left, '
