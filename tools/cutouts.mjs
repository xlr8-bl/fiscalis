 ...
 * to assets/cutouts/<role>/ with a manifest in assets/js/hooks/cutouts.js.
 *
...
import { ROLES, ROLE_NAMES } from '../assets/js/hooks/art.js';
...
const manifest = existsSync('assets/js/hooks/cutouts.js')
  ? (await import('../assets/js/hooks/cutouts.js')).CUTOUTS ?? {}
  : {};
...
writeFileSync('assets/js/hooks/cutouts.js',
