...
/* No slide numbers. "03 / 07" tells the reader how much is left, which
   is a reason to stop, and it is the first thing that makes a deck look
   like a template. The handle and the arrow are the only furniture. */
const HANDLE = {
