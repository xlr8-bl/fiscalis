...
export const LAYOUTS = {
  ...
  h024: {
    ...
    slots: [
      ...
      { id: 'answer', t: 'type', box: [0.088, 0.330, 0.185, 0.260],
        role: 'body', weight: '500', fill: 'mark',
        fit: 'shrink', size: 0.019, min: 0.014,
        wants: 'One line. The reason nobody else is going to do it. Plain, not '
             + 'clever: this is the half of the sheet that has to be true.' },
  ...
  h006: {
    ...
    slots: [
      ...
      { id: 'plate', t: 'art', own: 'sky-arms', cut: true, flip: 'x',
        box: [0.045, 0.288, 0.430, 0.390],
