...
export const LAYOUTS = {
  ...
  h035: {
    ...
    slots: [
      { id: 'scene', t: 'art', role: 'scene', box: [0.075, 0.058, 0.850, 0.897],
      ...
      { id: 'grid', t: 'grid', box: [0.075, 0.058, 0.850, 0.897],
        cell: [0.0874, 0.086], fill: 'mark', weight: 0.0016, alpha: 0.55 },

      { id: 'runA', t: 'tiles', box: [0.150, 0.139, 0.262, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 1 of the question, 3 letters. One cell per letter.' },
      { id: 'runB', t: 'tiles', box: [0.299, 0.222, 0.612, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 2 of the question, 8 letters. One cell per letter.' },
      { id: 'runC', t: 'tiles', box: [0.070, 0.468, 0.699, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 3 of the question, 8 letters. One cell per letter.' },
      { id: 'runD', t: 'tiles', box: [0.243, 0.601, 0.350, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 4 of the question, 4 letters. One cell per letter.' },
      { id: 'runE', t: 'tiles', box: [0.460, 0.654, 0.350, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 5 of the question, 4 letters. One cell per letter.' },
      { id: 'runF', t: 'tiles', box: [0.158, 0.725, 0.437, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 6 of the question, 5 letters. One cell per letter.' },
      { id: 'runG', t: 'tiles', box: [0.539, 0.869, 0.262, 0.086],
        fill: 'ground', on: 'mark', size: 0.62,
        wants: 'Part 7 of the question, 3 letters. One cell per letter.' },

      { id: 'railTL', t: 'type', box: [0.075, 0.021, 0.300, 0.016],
        role: 'grotesque', weight: '500', fill: 'mark', align: 'left', track: 0.04,
        fit: 'shrink', size: 0.013, min: 0.009,
        wants: 'What you do, in three or four words, caps. Not the handle.' },
      { id: 'railTR', t: 'type', box: [0.625, 0.021, 0.300, 0.016],
        role: 'grotesque', weight: '500', fill: 'mark', align: 'right', track: 0.04,
        fit: 'shrink', size: 0.013, min: 0.009,
        wants: 'The handle, caps.' },
      { id: 'railBL', t: 'type', box: [0.075, 0.957, 0.300, 0.016],
        role: 'grotesque', weight: '500', fill: 'mark', align: 'left', track: 0.04,
        fit: 'shrink', size: 0.013, min: 0.009,
        wants: 'The handle again. The four rails repeat two lines diagonally, so '
             + 'this one matches the top right.' },
      { id: 'railBR', t: 'type', box: [0.625, 0.957, 0.300, 0.016],
        role: 'grotesque', weight: '500', fill: 'mark', align: 'right', track: 0.04,
        fit: 'shrink', size: 0.013, min: 0.009,
  ...
  h021: {
    ...
    slots: [
      ...
      { id: 'word', t: 'type', over: 'art', polarity: 'keep',
        box: [0.248, 0.398, 0.506, 0.114],
        role: 'black', weight: '900', fill: 'mark', align: 'center',
        fit: 'shrink', size: 0.107, min: 0.070,
      ...
      { id: 'under', t: 'type', over: 'art', polarity: 'keep',
        box: [0.420, 0.558, 0.160, 0.026],
        role: 'grotesque', weight: '700', fill: 'mark', align: 'center', track: 0.04,
        fit: 'shrink', size: 0.020, min: 0.013,
      ...
      { id: 'run', t: 'type', over: 'art', polarity: 'keep',
        box: [0.015, 0.938, 0.970, 0.048],
        role: 'grotesque', weight: '700', fill: 'mark', align: 'left',
        fit: 'shrink', size: 0.012, min: 0.008, leading: 1.9, alpha: 0.62,
