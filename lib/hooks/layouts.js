...
export const LAYOUTS = {
  ...
  h051: {
    ...
    slots: [
      ...
      { id: 'figure', t: 'art', role: 'figure', flip: 'x', pin: false,
  ...
  h006: {
    ...
    slots: [
      ...
      { id: 'plate', t: 'art', role: 'portrait', cut: true, flip: 'x',
        // taken to the left edge and mirrored, so he faces into the sheet
        box: [0.000, 0.245, 0.560, 0.640],
