...
export const LAYOUTS = {
  ...
  h004: {
    ...
    slots: [
      ...
      { id: 'glassA', t: 'type', box: [0.085, 0.330, 0.850, 0.290],
        ...
        glass: true, blur: 0.030, lift: 1.09, sat: 0.92, frost: 0.05,
        bevel: 0.007, bevelLight: 0.26, bevelDark: 0.16,
        fit: 'shrink', size: 0.380, min: 0.200, vAlign: 'bottom',
        wants: 'The first half of one word, in frosted glass, three or four '
             + 'letters. It is not read so much as noticed.' },
  ...
  /* h010: rail .040/.940; head three lines .085/.135 .800x.190, .120/.400
   * and .100/.660; objects scattered at .580/.030, .050/.430, .560/.700. */
  h010: {
    id: 'h010', family: 'collage-cutout', ground: 'navy', ref: 'h010',

    does: 'Three lines of a serif sentence stepped down a dark ground, with cut-out '
        + 'objects floating between them and a small mark tucked in the gaps. The '
        + 'objects are period hardware, so the sheet reads as nostalgic without '
        + 'saying anything nostalgic. For a claim about how things used to be done '
        + 'and still are.',
    avoid: 'The objects have to be recognisably OLD. Modern hardware in this '
         + 'arrangement just looks like a product page with the type in the wrong '
         + 'place.',

    slots: [
      { id: 'objA', t: 'art', role: 'object', box: [0.560, 0.020, 0.400, 0.230],
        treat: 'contain', wants: 'One cut-out object, top right.' },
      { id: 'objB', t: 'art', role: 'object', box: [0.030, 0.420, 0.400, 0.240],
        treat: 'contain', wants: 'A second cut-out, left, behind the type.' },
      { id: 'objC', t: 'art', role: 'object', box: [0.540, 0.690, 0.420, 0.230],
        treat: 'contain', wants: 'A third cut-out, bottom right.' },
      { id: 'lineA', t: 'type', box: [0.080, 0.130, 0.520, 0.100],
        role: 'didone', weight: '500', fill: 'mark',
        fit: 'shrink', size: 0.098, min: 0.048, vAlign: 'bottom',
        wants: 'The first word or two of one sentence.' },
      { id: 'note', t: 'type', box: [0.080, 0.250, 0.300, 0.075],
        role: 'body', weight: '500', fill: 'mark', alpha: 0.85,
        fit: 'wrap', size: 0.019, min: 0.013, leading: 1.35,
        wants: 'Two small lines with a glyph beside them. An aside.' },
      { id: 'lineB', t: 'type', box: [0.115, 0.360, 0.520, 0.100],
        role: 'didone', weight: '500', fill: 'mark',
        fit: 'shrink', size: 0.098, min: 0.048, vAlign: 'bottom',
        wants: 'The middle of the sentence, stepped right.' },
      { id: 'lineC', t: 'type', box: [0.095, 0.630, 0.560, 0.110],
        role: 'didone', weight: '500', fill: 'mark',
        fit: 'shrink', size: 0.105, min: 0.048, vAlign: 'bottom',
        wants: 'The end of the sentence, with a full stop.' },
      { id: 'mark', t: 'type', box: [0.320, 0.940, 0.360, 0.030],
        role: 'grotesque', weight: '600', fill: 'mark', align: 'center', track: 0.06,
        fit: 'shrink', size: 0.018, min: 0.012, wants: 'A studio name at the foot.' },
    ],
  },
  ...
  h028: {
    id: 'h028', family: 'collage-cutout', ground: 'paper', ref: 'h028',
  ...
  h030: {
    id: 'h030', family: 'collage-cutout', ground: 'paper', ref: 'h030',
