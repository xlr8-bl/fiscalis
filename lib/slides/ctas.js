...
export const CTAS = {
  ...
  /**
   * The whole figure, seated, phone in hand, and no cut: the chair does
   * not survive one. It is 922x1152, the sheet's own shape, so it fills
   * one with nothing cropped, and the design is the photograph with as
   * little type over it as a closing slide can get away with. Its quiet
   * band is the top eighth only, so the wash carries the rest.
   */
  'on-the-phone': {
    photo: 'phone-chair',
    close: 'the harder version',
    slide: {
      template: 'close', ground: 'paper',
      handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
      scene: 'phone-chair', veil: 0.58,
      align: 'left', anchor: 'top', column: 0.66,
      ...
      /* Corner, not row: a row lands mid-sheet, which on a full-bleed
         photograph means across his chest. The corner is the white sweep
         at the top right, measured flat at luminance 242. */
      icons: ['message', 'loading'], iconsWhere: 'corner',
