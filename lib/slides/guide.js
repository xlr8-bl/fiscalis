...
export function probeSlide(name, lines) {
  ...
  for (const b of blocks) {
    ...
    if (b === 'portrait') keep.add('portrait');
  }
...
export const HOW_TO_OPEN = {
  ...
  checked:
    'The first slide is refused if its headline carries no concrete anchor '
    + 'at all: no object from the work and no number. That catches the '
    + 'category label. It cannot tell you whether the line is any good.',
};
