...
export const HOW_TO_USE_PICTURES = {
  ...
  how: 'Name a file from the library in `scene`. It fills the frame and the '
    ...
    + 'ghost in it.',
  two_cannot_be_cut: 'black-wall and phone-chair are scenes, not cut-outs, '
    + 'and for different reasons. black-wall fails at the key: black ground, '
    + 'black jacket. phone-chair keys fine and fails at the size, because the '
    + 'chair is chrome tubing about six pixels across at the size a sheet '
    + 'draws it and the cut is coarse on purpose, so it bridges the tubes and '
    + 'the chair comes back as white slabs. Asking for a cut-out of either '
