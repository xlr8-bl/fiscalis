...
export const HOW_TO_USE_ICONS = {
  ...
  where: [
    ...
    '"scatter" drops them into the HEADLINE itself: at the ragged end of '
    + 'each line, just past the last letter, at different sizes and turned '
    + 'off square, drawn BEHIND the type so the words stay crisp. It is the '
    + 'strongest of the four and the one that makes a sheet look made rather '
    + 'than filled in. Use it on the opener or on one middle slide, and never '
    + 'on a slide that also has chips: the eye cannot take both.',
