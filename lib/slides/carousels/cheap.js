...
export const CHEAP = [
  {
    ...
    railR: 'Douala, working worldwide',
    setup: 'One of them looks',
    index: '04',
    hero: 'CHEAP',
  ...
  {
    _name: '04-portrait', template: 'portrait', ground: 'paper',
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
  ...
  },
  {
    ...
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    echo: 'CHEAP',
    title: 'It was never the money.',
    say: 'Every one of those three is free to fix and none of them needs a '
       + 'rebuild. They are decisions, and decisions can be made again.',
    icons: ['idea', 'eye', 'rise'],
