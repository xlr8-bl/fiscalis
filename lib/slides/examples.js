...
export const EXAMPLE_SLIDES = [
  ...
  },
  {
    ...
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    tag: 'the form', foot: 'Three things, and none of them is the design.',
  ...
  {
    _name: 'roundup', template: 'roundup', ground: 'paper',
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    tag: 'the tools', foot: 'All four are free, and three take a minute.',
    title: 'Where a page gets decided',
    say: 'Three of these are free and the fourth is where most of the work '
       + 'happens before anything is built.',
    stack: [
      { app: 'figma', name: 'Figma', url: 'figma.com',
        line: 'Where the page is decided before anybody builds it.' },
      { app: 'googlefonts', name: 'Google Fonts', url: 'fonts.google.com',
        line: 'Two weights of one face, and your site stops looking cheap.' },
      { app: 'pagespeedinsights', name: 'PageSpeed', url: 'pagespeed.web.dev',
        line: 'Paste your address, read one number, ignore the rest.' },
      { app: 'googlesearchconsole', name: 'Search Console', url: 'search.google.com',
        line: 'What people typed to find you. Free, and usually never opened.' },
    ],
    source: 'All four checked, September 2026.',
  },
  {
    _name: 'numbers', template: 'numbers', ground: 'paper',
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    title: 'What the packs hold',
    trio: [{ figure: '28', of: 'app marks' },
           { figure: '20', of: 'pixel icons' },
           { figure: '16', of: 'the kit' }],
    say: 'Three sets, three registers. The kit explains, the pixel set jokes, '
       + 'and the marks name somebody else\'s product.',
    source: 'Counted in assets/icons, September 2026.',
  },
  {
    _name: 'myth', template: 'myth', ground: 'paper',
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    title: 'The logo is not the brand',
    swap: [{ head: 'A brand is a logo and a colour',
             tail: 'A brand is what it repeats' }],
    say: 'Nobody remembers a hex code. They remember that you always answer '
       + 'the same day, and that every page sounds like the same person.',
    icons: ['idea', 'eye', 'ring'],
  },
  {
    _name: 'checklist', template: 'checklist', ground: 'paper',
    handle: 'WEB3ASHLEY', series: 'SITE CHECKS',
    title: 'Four minutes, on a phone',
    say: 'Nothing to install. Open your own site and do these in order:',
    chips: ['tap your own number', 'send yourself an enquiry',
            'read your hours on Google', 'count the typefaces'],
    say2: 'Whichever one fails is costing you something today, and it is '
        + 'almost never what you were about to pay to change.',
    icons: ['click', 'message', 'target', 'no'],
    source: 'The four I run before quoting on anything.',
  },
  {
  ...
  },
  {
    ...
    chips: ['the browser tab', 'a bookmark', 'the phone home screen'],
    icons: ['browser', 'eye'],
  },
  {
    ...
    icons: ['folder', 'no', 'idea'],
    source: 'Simple Icons DISCLAIMER.md, read September 2026.',
  },
  {
    ...
    say2: 'None of them is wrong. The question is which one you can still '
        + 'edit yourself in two years, without ringing anybody.',
    icons: ['folder', 'code', 'ring'],
  },
  {
