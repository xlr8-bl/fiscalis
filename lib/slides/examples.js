...
export const EXAMPLE_SLIDES = [
  ...
  },
  {
    ...
    say: 'You do not need anything installed. Open your own site and do these '
       + 'in order:',
    chips: ['tap your own number', 'send yourself an enquiry',
            'read your hours on Google', 'count the typefaces'],
    say2: 'Whichever one fails is the one costing you something today, and it '
        + 'is almost never the thing you were about to pay to change.',
