...
export const INSTRUCTIONS =
  'The back of house for one person\'s social pipeline. A cycle is: progress to see '
  + 'what happened since last time, brief, then plan_carousel for each of the day\'s '
  + 'posts, then draw for each one, then hand_over, then send_digest. deliver_slide '
  + 'is there for a picture you made yourself; draw is the usual way. '
  + 'Poll queue to find slides a person has asked for again and redraw only those. '
  + 'Reference pictures handed over in a chat go in with add_reference; performance '
  + 'says how the posts did. Nothing here is public and nothing decides for itself: '
