...
export const INSTRUCTIONS =
  ...
  + 'the posts did. Approving, scheduling, posting and deleting a carousel belong '
  + 'to a person and are not available through this server.\n\n'
  ...
  + 'thing, not an idea.\n\n'
  + 'publish_article is the ONLY tool on this server that makes anything public, '
  + 'and it is the only one declared destructive, so it is the one a client should '
  + 'ask about. Everything else is additive and a person can undo it from the '
