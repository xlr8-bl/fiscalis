...
export const SETTINGS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'agent.other_engines', type: 'select', label: 'How it may make one',
        options: [['0', 'The templates only'], ['1', 'The older engines as well']],
        help: 'The templates only means every carousel comes out of '
            + 'teach_carousel: a named arrangement per slide, drawn here on a '
            + 'canvas, measured type on a ground whose contrast is known, free. '
            + 'The other two engines are still there — one files slides that are '
            + 'a generated picture and needs an image model, the other files '
            + 'setup-and-payoff panels on device mockups that look like a '
            + 'different account. Spark reached for both on its own, so this is a '
