...
const SUBJECTS = [
  ...
  { id: 'nap', angle: 'The same business, three different addresses across the web.',
    look_for: 'Find one business listed in three places and write down exactly how the name, address and phone differ. Find out which one a search engine treats as canonical.' },
  { id: 'photos-own', angle: 'One real photograph beats ten stock ones.',
  ...
  { id: 'thankyou', angle: 'The page after the form, which nobody designs.',
  ...
  { id: 'menu', angle: 'A menu that is a photograph of a menu.',
  ...
  { id: 'hosting', angle: 'Who actually holds the keys to your website.',
  ...
  { id: 'ssl', angle: 'The warning that empties a website in one afternoon.',
  ...
  { id: 'gallery', angle: 'A gallery of work nobody can tell apart.',
    look_for: 'Look at three portfolios in one trade and note what each caption says. Find out what a buyer wants captioned.' },
  { id: 'faq', angle: 'The questions you answer on the phone twenty times a week.',
    look_for: 'Ask a business what they get asked most and compare that with what their site answers. Write down both lists.' },
  { id: 'seasonal', angle: 'The page that still says Christmas in March.',
    look_for: 'Find out what stale dated content does to a listing and a search result, and how long a cached page persists.' },
  { id: 'directory', angle: 'The paid directory that sends nobody.',
  ...
  { id: 'reply-time', angle: 'The reply that arrives after they booked somebody else.',
  ...
  { id: 'video', angle: 'The video that plays for nobody and costs everybody.',
    look_for: 'Find what an autoplaying background video weighs, and what it does on a metered connection.' },
  { id: 'cookies', angle: 'The banner that covers the only button.',
    look_for: 'Find the current UK rules on what a small business site actually needs a banner for, and what most banners are doing that is not required.' },
  { id: 'social-proof', angle: 'Testimonials nobody believes.',
    look_for: 'Find what makes a quote read as real. Look for research on attribution, specificity and photographs rather than opinion pieces.' },
  { id: 'search-terms', angle: 'The words on the page versus the words in the search box.',
    look_for: 'Take one trade and find the actual queries people use, from a source that reports real searches rather than guesses.' },
  { id: 'phone-tap', angle: 'A phone number that is not a link.',
  ...
  { id: 'redirects', angle: 'The old pages you deleted, and the people still looking for them.',
  ...
  { id: 'ownership', angle: 'What you own when the person who built it stops answering.',
    look_for: 'List exactly what a business needs to hold to move a site elsewhere. Find out which of those a typical arrangement leaves with somebody else.' },
];
