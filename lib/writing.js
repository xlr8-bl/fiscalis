...
export async function writingBrief(db) {
  ...
  return {
    ...
    the_cycle: [
      ...
      'publish_article to put one on the site now, or schedule_articles to put a '
      + 'batch out over the next few days. Those are the only two calls that will '
      + 'ask the account holder to confirm, and schedule_articles asks once for '
      + 'the whole batch.',
    ],
